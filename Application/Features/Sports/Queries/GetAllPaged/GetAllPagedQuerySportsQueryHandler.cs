...
{
    public class GetAllPagedQuerySportsQueryHandler : IRequestHandler<GetAllPagedSportsQuery, PagedResponse<IList<GetAllPagedSportsResponse>>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;
        public GetAllPagedQuerySportsQueryHandler(
