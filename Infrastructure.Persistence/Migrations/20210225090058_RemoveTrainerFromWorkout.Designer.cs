...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20210225090058_RemoveTrainerFromWorkout")]
    partial class RemoveTrainerFromWorkout
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.PersonalTraining", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Domain.Entities.ScheduleEvent", b =>
                {
                    ...
                    b.Property<bool>("TrainerMembershipIsChanged")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Entities.ScheduleEventTrainer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("ScheduleEventTrainers");
                });
            ...
            modelBuilder.Entity("Domain.Entities.ScheduleEventTrainer", b =>
                {
                    b.HasOne("Domain.Entities.ScheduleEvent", "ScheduleEvent")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Trainer", b =>
                {
                    b.HasOne("Domain.Entities.ScheduleEvent", null)
                        .WithMany("Trainers")
                        .HasForeignKey("ScheduleEventId");
